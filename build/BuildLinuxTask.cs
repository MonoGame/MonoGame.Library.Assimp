...
public sealed class BuildLinuxTask : FrostingTask<BuildContext>
{
    ...
    public override void Run(BuildContext context)
    {
        ...
        context.StartProcessWithDocker("cmake", workingDirectory: buildWorkingDir, args: "-DASSIMP_BUILD_ZLIB=ON -DASSIMP_BUILD_TESTS=OFF -DASSIMP_INSTALL=OFF -DBUILD_SHARED_LIBS=ON CMakeLists.txt");
